      ...
      <?php if($message!="") { echo $message; } ?>
						  ...
						  <fieldset class="input">
						    <p id="login-form-username">
						      ...
						      <input id="modlgn_username" type="text" name="Email" placeholder="Email" class="inputbox" size="18" autocomplete="off">
						    </p>
						    <p id="login-form-password">
						      <label for="modlgn_passwd">Password</label>
						      <input id="modlgn_passwd" type="password" name="password" placeholder="password" class="inputbox" size="18" autocomplete="off">
						    </p>
						    <div class="remember">
