            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <tr>
	                  ...
	                  <td><?PHP echo $article['descreptionA']; ?></td>
	                  <td><?PHP echo $article['dateA']; ?></td>
	                  <td><img src="../img/photosarticle/<?php echo $article['imageA'] ?>" width = "200" height = "200" ></td>
                    ...
                    <form method="POST" action="editerarticle.php">
